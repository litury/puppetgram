        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-tertiary">{tStats('interactions')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-accent-500 mb-1">
                <AnimatedCounter target={2500} suffix="+" />
              </p>
              <p className="text-sm text-tertiary">{tStats('subscribers')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-primary mb-1">
                <AnimatedCounter target={150} suffix="+" />
              </p>
              <p className="text-sm text-tertiary">{tStats('channels')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-primary mb-1">
                <AnimatedCounter target={15} suffix="%" />
              </p>
              <p className="text-sm text-tertiary">{tStats('growth')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-widest text-accent-400 mb-3">{tFeatures('subtitle')}</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              icon={<BrainIcon />}
              title={tFeatures('ai_comments.title')}
              description={tFeatures('ai_comments.description')}
              delay={0}
            />
            <FeatureCard
              icon={<DevicesIcon />}
              title={tFeatures('scalable.title')}
              description={tFeatures('scalable.description')}
              delay={100}
            />
            <FeatureCard
              icon={<ShieldIcon />}
              title={tFeatures('protection.title')}
              description={tFeatures('protection.description')}
              delay={200}
            />
            <FeatureCard
              icon={<ChartIcon />}
            ...
            <FeatureCard
              icon={<TargetIcon />}
              title={tFeatures('targeting.title')}
              description={tFeatures('targeting.description')}
              delay={400}
            />
            <FeatureCard
              icon={<BoltIcon />}
              title={tFeatures('automation.title')}
              description={tFeatures('automation.description')}
              delay={500}
            />
          </div>
        </div>
      ...
      <footer className="py-8 px-6 md:px-8 lg:px-12 border-t border-neutral-800/50">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-accent-400">
            ...
            <span className="text-sm text-tertiary">{tFooter('copyright')}</span>
          </div>
